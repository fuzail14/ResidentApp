                ...
                child: Column(children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        IconButton(
                            icon: new SvgPicture.asset('assets/drawer.svg'),
                            onPressed: () {
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                              left: MediaQuery.of(context).size.width * 0.190),
                          child: Text(
                            'Home',
                            style: TextStyle(
                  ...
                  Row(
                      ...
                      children: [
                        ...
                        CustomContainer(
                          onTap: () {
                            Get.toNamed(gatekeeperreports, arguments: _homeScreenController.userdata);
                          },
